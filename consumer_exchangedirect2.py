...
Run consumer_exchangedirect1.py at the same time with this script
...
channel.queue_bind(exchange='myexchangename_direct', queue=queue_name, routing_key='pink_route')
print(queue_name)
